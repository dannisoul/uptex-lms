...
export function LoginBody ({ form }) {
  return (
    <div className='max-w-[1200px] w-10/12 mx-auto relative'>
      ...
      <section data-section='1' id='inicio' className='sm:pt-[150px] pt-[116px] customSection flex sm:gap-14 gap-4 semi-lg:justify-between justify-center items-center relative semi-lg:flex-nowrap flex-wrap place-content-center'>
        <article className='flex flex-col semi-lg:h-[492px] h-auto w-[408px] semi-lg:shrink-0 shrink relative'>
          ...
          <p className='max-w-[250px] text-sm font-medium text-primary-text mt-4 inline-block dark:text-dark-primary-text'>Donde podrás unirte a cursos que te ayudarán en tu desarrollo profesional.</p>
          <img className='w-80 absolute bottom-16 right-0 semi-lg:block hidden' src='/landingPage/login1.webp' alt='' />
        </article>
        {form}
      </section>
      ...
      <section data-section='4' id='caracteristicas' className=' pt-[120px] customSection flex items-center relative place-content-center'>
        <div className='w-full'>
          <h3 className='text-2xl font-bold text-primary-accent'>Caracteristicas</h3>
