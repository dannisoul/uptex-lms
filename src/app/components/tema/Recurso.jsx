...
export function Recurso ({ recurso, handleDeleteRecurso, updateRecurso, deletePermission, viewPermission, handleView, updateFile }) {
  ...
  const path = `${process.env.NEXT_PUBLIC_BUCKET || 'https://storage.googleapis.com/uptex_lms'}/uploads/${recurso.idDocente}/cursos/${recurso.idCurso}/${recurso.idUnidad}/${recurso.idTema}/${recurso.nombre}`
  return (
