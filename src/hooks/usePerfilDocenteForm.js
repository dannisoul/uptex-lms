...
import validarDireccion from '@/validators/usuario/direccion'
import validarEspecialidad from '@/validators/usuario/especialidad'
import validarFacebook from '@/validators/usuario/facebook'
import validarInstagram from '@/validators/usuario/instagram'
import validarNacimiento from '@/validators/usuario/nacimiento'
import validarNacionalidad from '@/validators/usuario/nacionalidad'
import validarNombre from '@/validators/usuario/nombre'
import validarTelefono from '@/validators/usuario/telefono'
import validarTwitter from '@/validators/usuario/twitter'
